...
class TestNRPE(TestCase):
    ...
    def test_sync_nrpe_files(
        self, mock_plugins_dir_path, mock_check_script_dst_path, mock_rsync, mock_charm_dir
    ):
        """Test sync_nrpe_files function."""
        mock_check_script_dst_path.__str__ = MagicMock(return_value="/mock/dst")
    ...
    def test_update_nrpe_config(self, mock_sync_nrpe_files, mock_nrpe_compat):
